...
'https://chefs-view.herokuapp.com/register' = register - create new user WILL ERROR 404 NOT FOUND
'https://chefs-view.herokuapp.com/users' = users endpoint // WILL ERROR 401 NOT AUTHORIZED
